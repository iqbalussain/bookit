# Bit2book v12.1.0 - Installation Guide (Windows)

## Overview
Bit2book is a desktop invoice and accounting management system for Windows. This guide explains how to install and use it on your PC.
...
Use the installer file named like `Bit2book Setup 12.1.0.exe`.

**Install steps:**
1. Download `Bit2book Setup 12.1.0.exe`
...
7. Launch **Bit2book** from the desktop shortcut or Start Menu

**What this installer does:**
- Installs Bit2book like a normal Windows app
...
1. **Run Bit2book** - Open it from the desktop shortcut or Start Menu
...
- **Offline mode:** Bit2book works fully on one PC with local data storage.
...
Bit2book uses SQLite for data storage. Your database is stored at:
```
C:\Users\{YourUsername}\AppData\Local\Bit2book\invoiceflow.db
```
...
- **Antivirus Blocking:** Your antivirus may block a new installer on first run. Whitelist `Bit2book Setup 12.1.0.exe`
...
- **Reinstall:** Uninstall Bit2book, then run the installer again as administrator
...
2. Search for **Bit2book**
3. Right-click it → **Open file location**
4. Right-click **Bit2book** → **Send to** → **Desktop (create shortcut)**

## Uninstalling

Bit2book uses a normal Windows installer, so removal is simple:

1. Open **Settings → Apps → Installed apps**
2. Find **Bit2book** and click **Uninstall**
3. (Optional) Delete the database folder to completely remove all data:
   ```
   C:\Users\{YourUsername}\AppData\Local\Bit2book\
   ```
...
| File | Purpose |
|------|---------|
| `Bit2book.exe` / `Bit2book-12.1.0.exe` | Main application executable - run this to start Bit2book |
...
**Ready to use?** Start Bit2book now by running `Bit2book-12.1.0.exe`!
